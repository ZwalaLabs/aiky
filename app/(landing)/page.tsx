					...
					<div className="container px-4 md:px-6">
						<div className="flex flex-col items-center space-y-6 text-center">
							<div className="space-y-4 py-4">
								...
								<p className="mx-auto max-w-[700px] text-gray-800 pt-3 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
									The platform for creators to connect with their audience.
					...
					<div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
						...
						<div className="flex flex-col justify-center space-y-4">
							<ul className="grid gap-6">
								<li>
									<Card className="px-2 py-4 w-[450px]">
					...
					<div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
						<div className="space-y-2">
							...
							<p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
								...
								<span className="text-primary font-bold">AIKY</span> today and
								start building meaningful connections, making a difference, and
								creating a stronger, more vibrant community.
							</p>
						</div>
					</div>
				</section>
